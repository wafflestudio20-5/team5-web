...
export const styleFeedExample: StyleFeed[] = [
  {
    id: 1,
    images: [
  ...
  },
  {
    ...
    nickname: "kream123",
    content: "#데일리코디 #ootd #크림스타일 #눕시패딩 #thenorthface",
  },
  {
    id: 3,
    images: [
    ...
    nickname: "typescript1",
    content:
      "추워서 어떻게 입어야될지 모르겠다 ㅠ 아우터 고르기가 젤 힘들어 ,, #KREAM스타일 #슈프림포.",
  },
  {
    id: 4,
    images: [
  ...
  },
  {
    ...
    nickname: "123456",
    content:
      "삼바 og로 코디에 포인트 주기 #KREAM스타일 #KREAM챌린지 #kream데일리 #크림스타일 ",
  },
  {
    id: 6,
    images: [
    ...
    nickname: "123456",
    content:
      "🐾 #늦었지만 #메리크리스마스🌲 #메리크리스마스챌린지 #일상룩 #일상스타그램 #유니크룩 #데",
  },
  {
    id: 7,
    images: [
    ...
    profile: "https://pbs.twimg.com/media/Eq363JzVkAAZIfQ.jpg",
    nickname: "123456",
    content: "#cpcompany #CP컴퍼니 #nike #dunk #프라이탁 #frietag #CP컴퍼니",
  },
  {
    id: 8,
    images: [
  ...
  },
  {
    ...
    nickname: "123456",
    content:
      "#yeezyfoamrunner #이지폼러너 #이지폼러너샌드 #yeezy #mpq #발마칸코트 #코트코디 #",
  },
  {
    id: 10,
    images: [
